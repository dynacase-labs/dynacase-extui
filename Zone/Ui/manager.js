...
Ext.fdl.Interface = Ext.extend(Ext.util.Observable, {
    ...
    constructor: function(config){
        ...
        this.subscribe('closedocument', function(id){
            console.log('Event Received in Ext.fdl.Interface : closedocument', id);
            this.onCloseDocument(id);
        }, this);
    ...
    displayFamily: function(id){
        ...
        var addButton = new Ext.Button({
            icon: 'EXTUI/Images/add.png',
            text: 'Ajouter',
            disabled: true
        });
        
        var deleteButton = new Ext.Button({
            icon: 'EXTUI/Images/delete.png',
            text: 'Supprimer',
            disabled: true
        });
        
        var saveButton = new Ext.Button({
            icon: 'EXTUI/Images/application_edit.png',
            text: 'Sauver',
            disabled: true
